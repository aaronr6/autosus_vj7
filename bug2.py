...
class Bug2(Node):
    def __init__(self):
        ...
        #Parametri za upravljanje algoritmom
        ...
        self.yaw_precision = 2 * (math.pi / 180)  # Precision for yaw adjustment
        self.dist_precision = 0.1  # Precision for goal distance
        self.distance_to_start_goal_line_precision = 0.1
        self.leave_point_to_hit_point_diff = 0.2
        self.dist_thresh_obs = 0.5  # Distance threshold for obstacle detection
        self.dist_thresh_wf = 0.45  # Distance threshold for wall following
        self.dist_too_close_to_wall = 0.4  # Too close distance to the wall
        self.dist_thresh_bug2 = 0.5  # Distance threshold for Bug2 algorithm

        #senzori
        self.leftfront_dist = 0.0
        self.rightfront_dist = 0.0

        #Trenutna pozicija i orijentacija
        self.current_x = 0.0
        self.current_y = 0.0
    ...
    def location_callback(self, msg):
        ...
        self.current_yaw = transform.euler_from_quaternion(q)[2]
    ...
    def follow_wall(self):
        ...
        if distance_to_start_goal_line < self.distance_to_start_goal_line_precision:
            ...
            if diff > self.leave_point_to_hit_point_diff:
                ...
                self.go_to_goal_state = "adjust heading"
                msg.linear.x = 0.0
                msg.angular.z = self.turning_speed_wf_fast + 2 
                self.cmd_pub.publish(msg)
                return             
